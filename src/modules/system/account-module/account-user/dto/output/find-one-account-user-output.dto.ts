...
import { AccountUserStatus, AccountUserType, User } from '@prisma/client';
import { FindOneAccountIdNameOutputDto } from '../../../account/dto/output/find-one-account-output.dto';

export class FindOneAccountUserOutputDto {
  @ApiProperty({
  ...
  @ApiProperty({
    example: '2022-01-01T00:00:00Z',
    description: 'The date when the AccountUser was deleted',
    type: FindOneAccountIdNameOutputDto,
    required: false,
  })
  account?: FindOneAccountIdNameOutputDto;
}
