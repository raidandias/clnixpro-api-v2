...
export class FindAllItemExamInputQueryDto {
  @ApiProperty({
  ...
  @IsString({ message: 'Item Catalog Exam ID must be a string.' })
  @IsUUID(4, { message: 'Item Catalog Exam ID must be a valid UUID.' })
  @IsOptional()
