...
export class FindOneItemHealthInsuranceOutputDto {
  @ApiProperty({
  ...
  @ApiProperty({
    description: 'The related item details',
    type: () => FindOneItemOutputDto,
  })
  item: FindOneItemOutputDto;

  @ApiProperty({
    description: 'The related health insurance details',
    type: () => FindOneHealthInsuranceOutputDto,
  })
  healthInsurance: FindOneHealthInsuranceOutputDto;
}
