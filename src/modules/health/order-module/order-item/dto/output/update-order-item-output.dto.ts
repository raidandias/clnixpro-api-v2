...
export class UpdateOrderItemOutputDto {
  @ApiProperty({
  ...
  @ApiProperty({
    example: 2,
    description: 'The updated quantity of the item in the order.',
  })
  quantity: number;
  ...
  @ApiProperty({
    example: '2024-01-15T10:00:00Z',
    description: 'The date and time when the order item was deleted.',
    nullable: true,
  })
  deletedAt: Date | null;
}
