...
export class DeleteHealthMedicalCareOutputDto {
  @ApiProperty({
  ...
  @ApiProperty({
    example: HealthMedicalCareStatus.CANCELED,
  ...
  @ApiProperty({
    example: '2024-01-15T10:00:00Z',
    description: 'The date and time when the medical care record was soft deleted.',
    nullable: true,
  })
  deletedAt: Date | null;
}
