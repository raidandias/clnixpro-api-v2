...
export class FindOneInvoicePayableOutputDto {
  ...
  @ApiProperty({ example: '2024-01-15T10:00:00Z', description: 'The date and time when the invoice payable was deleted.', nullable: true })
  deletedAt: Date | null;
}
