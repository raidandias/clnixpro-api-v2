...
export class DeleteInvoiceReceivableOutputDto {
  ...
  @ApiProperty({ example: '2024-01-15T10:00:00Z', description: 'The date and time when the invoice receivable was soft-deleted.', nullable: true })
  deletedAt: Date | null;
}
