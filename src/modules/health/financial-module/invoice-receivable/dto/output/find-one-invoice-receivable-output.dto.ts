...
export class FindOneInvoiceReceivableOutputDto {
  @ApiProperty({
  ...
  @ApiProperty({
    example: '2024-01-15T10:00:00Z',
    description: 'The date and time when the invoice receivable was created.',
  })
  createdAt: Date;

  @ApiProperty({
    example: '2024-01-15T10:00:00Z',
    description: 'The date and time when the invoice receivable was last updated.',
  })
  updatedAt: Date;

  @ApiProperty({
    example: '2024-01-15T10:00:00Z',
    description: 'The date and time when the invoice receivable was deleted.',
    nullable: true,
  })
  deletedAt: Date | null;
}
