...
export class DeleteInvoicePaymentOutputDto {
  ...
  @ApiProperty({ example: '2024-01-15T10:00:00Z', description: 'The date and time when the invoice payment was soft-deleted.', nullable: true })
  deletedAt: Date | null;
}
